# Création d'une application FullStack en utilisant React et une mini API pour ASP.NET Core

Dans le scénario de ce tutoriel vous incarnez l'un des membre de l'équipe chargé de la partie Front-end
